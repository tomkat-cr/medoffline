# MedOffLine Android App

**[UPDATE - 10/24]** ExecuTorch Team have added support for running quantized Llama 3.2 1B/3B models in demo apps on the [XNNPACK backend](https://github.com/pytorch/executorch/blob/main/examples/demo-apps/android/LlamaDemo/docs/delegates/xnnpack_README.md). We currently support inference with SpinQuant and QAT+LoRA quantization methods.

We’re excited to share that the newly revamped Android app is live and includes many new updates to provide a more intuitive and smoother user experience with a chat use case! This app showcases how easily ExecuTorch can be integrated into an Android app and how to exercise the many features ExecuTorch and Llama models have to offer.
...
Please dive in and start exploring our app today! We look forward to any feedback and are excited to see your innovative ideas.


## Key Concepts
From this app, you will learn many key concepts such as:
...
## Reporting Issues
If you encountered any bugs or issues following this tutorial please file a bug/issue here on [Github](https://github.com/tomkat-cr/medoffline/issues/new).
